        ...
        <div className="col-lg-4 col-md-12">
          <div className={classes.package}>
            ...
            <div className={classes.packageTitle}>
              ...
              <p>
                Become a guru of sales, by refreshing your sales systems and
                processes.{" "}
              </p>
            </div>
            <div className={classes.packageDetails}>
              ...
              <p>
                Access to 'Discover Phenomenal' content (Lifestyle Brand -
                Fitness, Fuel & Mindfulness).
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-4 col-md-12">
          <div className={classes.package}>
            ...
            <div className={classes.packageTitle}>
              ...
              <p>
                Build an exclusive talent pool and become a master of your sales
            ...
            <div className={classes.packageDetails}>
              <p>Monthly Face to Face/Video meeting to review Sales Progress</p>
              <p>
                Weekly Workshop - Sales Coaching & Mentorship on Prospecting,
                Business Development and New Sales.
              </p>
              <p>Accountability Partner & Soundboard</p>
              <p>
                Introductions to CDZ extensive ERP Network (Partner Alliance).
              </p>
              <p>
                Invites to all CDZ Events (Annual and Quarterly Networking
                Events).
              </p>
              <p>25% Discount for Professional Recruitment Services</p>
              <p>
                Access to 'Discover Phenomenal' content and online training
                (Lifestyle Brand - Fitness, Fuel & Mindfulness).
              </p>
              <p>Call us anytime - You are not alone.</p>
            </div>
          </div>
        ...
        <div className="col-lg-4 col-md-12">
          <div className={classes.package}>
            ...
            <div className={classes.packageTitle}>
              ...
              <p>
                Grow your business to new levels, become your very own ‘sales
                master’ and perfect leadership.{" "}
              </p>
            </div>
            <div className={classes.packageDetails}>
              <p>ALL ACCESS!</p>
              <p>
                Daily video calls - Sales Pipeline, Sales Review, Sales Coaching
                & Mentorship
              </p>
              <p>50% Discount for Professional Recruitment Services</p>
              <p>
                ALL ACCESS to 'Discover Phenomenal' (Lifestyle Brand - Fitness,
                Fuel & Mindfulness)
              </p>
            </div>
          </div>
